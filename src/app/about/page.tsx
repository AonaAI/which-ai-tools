    ...
    <main className="min-h-screen">
      <section className="bg-brand-darker border-b border-brand-dark">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">About WhichAITools</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        ...
        {/* Methodology */}
        <section className="bg-brand-darker border border-brand-dark rounded-lg p-8">
          <h2 className="text-3xl font-bold mb-6">Risk Scoring Methodology</h2>
          <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-brand-dark p-6 rounded-lg">
                <h4 className="font-bold text-white mb-2">Data Handling (40%)</h4>
              ...
              <div className="bg-brand-dark p-6 rounded-lg">
                <h4 className="font-bold text-white mb-2">Compliance (30%)</h4>
                <ul className="text-gray-300 text-sm space-y-2">
              ...
              <div className="bg-brand-dark p-6 rounded-lg">
                <h4 className="font-bold text-white mb-2">Security Controls (20%)</h4>
                <ul className="text-gray-300 text-sm space-y-2">
              ...
              <div className="bg-brand-dark p-6 rounded-lg">
                <h4 className="font-bold text-white mb-2">Transparency (10%)</h4>
                <ul className="text-gray-300 text-sm space-y-2">
            ...
            <div className="mt-8 p-6 bg-brand-darkest rounded-lg border border-brand-accent">
              <h4 className="font-bold text-white mb-4">Risk Level Interpretation</h4>
        ...
        >
          <h2 className="text-3xl font-bold mb-4">Powered by Aona AI</h2>
        ...
        <section className="text-center">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block bg-brand-accent hover:bg-purple-600 text-white px-8 py-3 rounded-lg font-bold transition"
          >
            Get in Touch
          </a>
        </section>
